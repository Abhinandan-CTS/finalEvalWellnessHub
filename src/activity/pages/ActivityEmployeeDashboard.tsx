...
function CategoryBadge({ category }: { category?: string }) {
  return <span className="badge-category">{category ?? "General"}</span>;
}
...
export default function ActivityEmployeeDashboard() {
  ...
  return (
    <div
      ...
      style={{ padding: "2.2rem", margin: "0 auto", maxWidth: 700 }}
    >
      <ToastContainer />
      ...
      <div className="prod-card mb-4" style={{ padding: "10px" }}>
          ...
          (loadingPrograms ? (
            ...
            <div className="row g-3">
              {availablePrograms.map((p) => (
                <div key={p.programId} className="col-12 col-md-6 col-lg-4">
